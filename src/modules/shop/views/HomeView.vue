<template>
  <section class="py-10 bg-gray-100">
    ...
    <!-- Cuando :products se queje porque encuentra que es undefined o null, se puede solventar utilizando una validacion cuando los productos no existan mostrar x y si hay productos mostrar los productos ahora si -->
    <div v-if="!products" class="text-center justify-center">
      <h1 class="text-center text-xl">Cargando productos</h1>
      <p>Espere porfavor</p>
    </div>
    <!-- Se pasan los productos -->
